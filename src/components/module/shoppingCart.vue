  ...
  <div>
    ...
    <div class="content">
      ...
      <el-table :data="currentItems" @selection-change="selectionChange" border style="width: 100%"
        ...
        <el-table-column prop="buyer_id" label="购物者id" sortable>
        </el-table-column>
        <el-table-column prop="goods_id" label="商品id" sortable>
        </el-table-column>
        <el-table-column prop="num" label="数量" sortable>
        </el-table-column>
        <el-table-column prop="seller_id" label="卖家id，店铺id" sortable>
        </el-table-column>
        <el-table-column prop="create_time" label="加入购物车的时间" sortable>
        </el-table-column>
        <el-table-column prop="is_checked" label="是否勾选，0：未勾选，1：勾选" sortable>
        </el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync="itemFormVisible" size="tiny" custom-class="account-dialog"
        ...
        <el-form :model="itemForm" ref="itemForm" label-width="70px" class="account-form"
                 :rules="itemFormRules">
          <el-form-item label="购物者id" prop="buyerId">
          ...
          <el-form-item label="卖家id，店铺id" prop="sellerId">
            <el-input v-model.number="itemForm.sellerId"></el-input>
          </el-form-item>
          <el-form-item label="加入购物车的时间" prop="createTime">
            <el-input v-model.number="itemForm.createTime"></el-input>
          </el-form-item>
          <el-form-item label="是否勾选，0：未勾选，1：勾选" prop="isChecked">
