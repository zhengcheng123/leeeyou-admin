  ...
  <div>
    ...
    <div class="content">
      ...
      <el-table :data="currentItems" @selection-change="selectionChange" border style="width: 100%"
        ...
        <el-table-column prop="name" label="用户登录名称" sortable>
        </el-table-column>
        <el-table-column prop="password" label="用户密码，可能需要加密处理" sortable>
        </el-table-column>
        <el-table-column prop="email" label="邮箱" sortable>
        </el-table-column>
        <el-table-column prop="phone" label="手机号" sortable>
        </el-table-column>
        <el-table-column prop="create_time" label="帐号创建时间" sortable>
        </el-table-column>
        <el-table-column prop="last_login_time" label="最后一次登录时间" sortable>
        </el-table-column>
  ...
  export default {
    data () {
      return {
        ...
        itemFormRules: {
          name: [
            {required: true, message: '请输入用户登录名称'}
          ],
          password: [
            {required: true, message: '请输入用户密码，可能需要加密处理'}
          ],
          email: [
          ...
          createTime: [
            {required: true, message: '请输入帐号创建时间'},
    ...
    methods: {
      ...
      editItem (item) {
        ...
        this.itemForm.lastLoginTime = item.last_login_time
        this.itemFormVisible = true
      },
      saveItem () {
