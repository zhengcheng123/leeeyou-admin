    ...
    <div class="content">
      ...
      <div class="search-bar">
        <div class="search-item">
          ...
          <el-input
            v-model="params.condition[0].value"
            placeholder="请输入"
        ...
        <div class="search-item">
          ...
          <el-input
            v-model="params.condition[1].value"
            @keyup.enter.native="search(params)"
            placeholder="请输入"
            clearable
            size="medium"
        ...
        <div class="search-btnT">
            <!-- v-if="$_has('logQuery')" -->
          <el-button  class="f-left" type="primary" size="small" @click="search(params)" >查询</el-button>
                      <!-- v-if="$_has('logDelete')" -->
          <el-button
           class="f-left"
            type="info"
      ...
      >
        ...
        >
          ...
          <el-table-column align="center" sortable min-width="120" prop="createName" label="用户名称"></el-table-column>
          <el-table-column align="center" prop="model" sortable min-width="120" label="操作对象"></el-table-column>
          ...
          <el-table-column
            ...
            label="参数"
          ></el-table-column>
          <el-table-column align="center" prop="createTime" sortable min-width="200" label="操作时间"></el-table-column>
          <el-table-column align="center" prop="consumeTime" min-width="120" sortable label="响应时间"></el-table-column>
          <el-table-column align="center" label="详情">
            <template slot-scope="scope">
              <el-button type="text" size="small" @click="showrequest(scope.row)">
                <span>报文</span>
              </el-button>
            </template>
          </el-table-column>
      ...
      >
        ...
        <span slot="footer" class="dialog-footer">
          <el-button type="primary" @click="closeModel">返 回</el-button>
        </span>
      </el-dialog>
    </div>
  </div>
...
export default {
  ...
  methods: {
      ...
      if (this.idBatch.length != 0) {
        this.$confirm("此操作将永久删除该条数据, 是否继续?", "提示", {
          ...
          .then(() => {
            ...
            this.$axios
              .post(globalConfig.server1 + "log/delete", arr)
              .then(res => {
    ...
    search() {
      ...
      this.$axios
        .post(globalConfig.server1 + "log/query", this.params)
        .then(res => {
          if (res.data.code == 200) {
