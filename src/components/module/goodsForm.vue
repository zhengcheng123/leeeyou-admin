  ...
  <div>
    ...
    <div class="content">
      <el-form>
        ...
        <el-tabs :value="activeTab" type="border-card" class="goods-info">
          <el-tab-pane label="选择商品类别" name="type" :disabled="true">
            <div class="row">
              <el-radio
          ...
          <el-tab-pane label="编辑基本信息" name="basic" :disabled="true">
              ...
              <div class="section-body">
                ...
                >
                  ...
                  <el-form-item label="详细类别：" prop="typeId">
                    <el-select v-model="goodsCommon.typeId" size="small" placeholder="请选择类别">
                      <el-option
                  ...
                  <el-form-item label="商品品牌：" prop="grandId">
                    <el-select v-model="goodsCommon.grandId" size="small" placeholder="请选择品牌">
                      <el-option
                    ...
                    <el-button type="text" @click="getGrands">刷新</el-button>
                    <!-- <el-button type="text">新建品牌</el-button> -->
                  </el-form-item>
                  <el-form-item label="商品名称：" prop="name">
                    <el-input size="small" class="select-input" v-model.trim="goodsCommon.name"></el-input>
                  </el-form-item>
                  <el-form-item label="商品描述：" prop="description">
                    <el-input
                      placeholder="描述不可超过1000字"
                      class="select-input"
                      size="small"
                  ...
                  <div class="item-body">
                    <div class="formats">
                      <div class="select-attr">
                        ...
                        <el-button @click="addPredictAttr" size="small" style="margin-left:20px">添加</el-button>
                      </div>
                      <ul>
                        <li
                          class="predict-attr"
                      ...
                      <el-button size="small" style="margin-top: 10px;" @click="generatePredictGoods">确认规格</el-button>
                    </div>
                  </div>
                </div>
                <div class="item">
                  ...
                  <div class="item-body no-flex">
                    ...
                    >
                      <el-table-column
                        ...
                        :key="attr.id"
                      ></el-table-column>
                      <el-table-column align="center" prop="canCellSize" label="可售库存" max-width="150">
                      ...
                      <el-table-column align="center" prop="canCellSize" label="库存" max-width="150">
                        <template slot-scope="scope">
                          <el-input
                      ...
                      <el-table-column align="center" prop="price" label="价格" max-width="150">
                        <template slot-scope="scope">
                          <el-input
                            class="sm-input"
                            size="small"
                      ...
                      <el-table-column align="center" prop="procurementPrice" label="成本" max-width="150">
                        <template slot-scope="scope">
                          <el-input
                            class="sm-input"
                            size="small"
                            @input="checknum2(scope.row)"
                            v-model.trim="scope.row.procurementPriceLabel"
                          ></el-input>
                        </template>
                      </el-table-column>
                       <el-table-column align="center" prop="weight" label="单品重量(kg)" max-width="150">
                        <template slot-scope="scope">
                          <el-input
                            class="sm-input"
                            size="small"
              ...
              <div class="section-body">
                 <div class="item">
                  ...
                  <div class="item-body" style="line-height: 41px;">
                     <el-radio v-model="logisticsType" label="1">物流配送</el-radio>
                     <el-radio v-model="logisticsType" label="2">支持自提</el-radio>
                     <el-radio v-model="logisticsType" label="3">物流+自提</el-radio>
                  </div>
                </div>
              </div>
            </div>
            <el-button @click="resetForms" size="small">返回</el-button>
            <el-button @click="validateBasic" type="primary" :loading="saving">提交</el-button>
          </el-tab-pane>
        </el-tabs>
      </el-form>
    </div>
  ...
  methods: {
      ...
      for (const goods of this.predictGoods) {
        if (
          !(
            ...
            this.validateNum(goods.size)&&this.validateNum(goods.weight)
          )
        ) {
    ...
    checknum(value) {
      ...
      value.priceLabel = value.priceLabel
        ...
        .replace("$#$", ".");
      //只能输入两位小数
      value.priceLabel = value.priceLabel.replace(
        /^(\-)*(\d+)\.(\d\d).*$/,
        "$1$2.$3"
      );
    },
    checknum2(value) {
      console.log(value)
      //如果输入非数字，则替换为''
      value.procurementPriceLabel = value.procurementPriceLabel.replace(
        /[^\d\.]/g,
        ""
      );
      //必须保证第一个为数字而不是.
      ...
      //保证.只出现一次，而不能出现两次以上
      value.procurementPriceLabel = value.procurementPriceLabel
        .replace(".", "$#$")
        .replace(/\./g, "")
        .replace("$#$", ".");
      //只能输入两位小数
      value.procurementPriceLabel = value.procurementPriceLabel.replace(
        ...
        checkWeight(value) {
      //如果输入非数字，则替换为''
      value.weight = value.weight.replace(
        /[^\d\.]/g,
        ""
      );
      //必须保证第一个为数字而不是.
