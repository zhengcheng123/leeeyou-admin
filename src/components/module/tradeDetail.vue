<template>
  <div class="trade-detail">
    ...
    <el-button class="download" @click="downloadOrder">下载订单快照</el-button>
    <div class="content" id="capture">
      <div class="out-info">
        <el-form :model="buyer" ref="buyerForm" label-width="110px">
          <div class="h3down">
             <h3>交易信息</h3> 
          </div>
          <el-row>
        ...
        <el-form :model="receiver" ref="outInfoForm" label-width="110px">
          <el-row>
            <el-col :span="6">
              <el-form-item label="交易状态：" prop="stat">
                <span>{{receiver.stat}}</span>
              </el-form-item>
            </el-col> 
            <el-col :span="6">
              <el-form-item label="付款时间：" prop="description">
                <span>{{dateTime(receiver.payTime)}}</span>
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item label="买家备注：" prop="comment">{{receiver.comment}}
      ...
      <div class="logistics-info">
        <el-form :model="logistics" :rules="logisticsRules" ref="logisticsForm" label-width="110px">
          <h3>收货人信息</h3>
          <el-row>
            <el-col :span="6">
            ...
            <el-col :span="6">
              <el-form-item label="收货人电话：" prop="mobile" class="validatable">
        ...
        <div class="logistics-info">
          ...
          >
            ...
            <el-row>
              <el-col :span="6">
                <el-form-item v-if="logistics.type===1" label="物流公司：" prop="logisticsName">
              ...
              <el-col :span="6">
                <el-form-item v-if="logistics.type===1" label="物流单号：" prop="logisticsCode">
                  <span>{{logistics.logisticsCode}}</span>
                </el-form-item>
              </el-col>
              <el-col :span="6">
              <el-form-item label="物流类型 :" prop="logisticsName">
                <span>{{logistics.type == 1 ? '邮递' : '自提'}}</span>
              </el-form-item>
            </el-col>
              <el-col :span="6">
                <el-form-item label="快递费￥：" prop="priceStr">
            ...
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="发货人号码：" prop="logisticsName">
      ...
      <div class="detail-info">
        <h3>商品明细</h3>
        <div class="row btns" v-if="pageAction ==='create'">
          <div class="left">
        ...
        <el-row>
          <el-col>
            <table border="1" cellpadding="0" cellspacing="0" class="NativeTable" height="100">
              <thead>
              <tr>
                <th>序号</th>
                <th>图片</th>
              ...
              <tr v-for="(row,i) in goods" :key="row.id" >
              <td>{{i+1}}</td>
              <td>
                <img class="imgDetail"
                    v-if="row.goodsPic"
                    ...
                    alt="商品图片" id="goodsPicImg" crossOrigin="anonymous"
                  />
              </td>
              <td>{{row.goodsName}}</td>
      ...
      this.$http
        ...
        .done(res => {
          if (res.result === 1) {
            ...
            this.states.find(ele =>
              ele.value === this.receiver.stat
                ? (this.receiver.stat = ele.label)
                : ""
            );
