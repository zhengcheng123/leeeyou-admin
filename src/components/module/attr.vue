  ...
  <div>
    <div class="content">
      ...
      <el-table :data="currentItems" @selection-change="selectionChange" border style="width: 100%"
        ...
        <el-table-column prop="name" label="商品的属性,大小，重量，机型等等" sortable>
        </el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync="itemFormVisible" size="tiny" custom-class="account-dialog"
        ...
        <el-form :model="itemForm" ref="itemForm" label-width="70px" class="account-form"
                 :rules="itemFormRules">
          <el-form-item label="商品的属性,大小，重量，机型等等" prop="name">
  ...
  export default {
    data () {
      return {
        ...
        itemFormRules: {
          name: [
            {required: true, message: '请输入商品的属性,大小，重量，机型等等'}
          ]
        },
        /* table */
        currentItems: [],
