  ...
  <div>
    ...
    <div class="content">
      ...
      <el-table :data="currentItems" @selection-change="selectionChange" border style="width: 100%"
        ...
        <el-table-column prop="seller_id" label="商家id" sortable>
        </el-table-column>
        <el-table-column prop="goods_id" label="物品id" sortable>
        </el-table-column>
        <el-table-column prop="price" label="礼品价格，默认是0" sortable>
        </el-table-column>
      ...
      <el-dialog title="编辑" :visible.sync="itemFormVisible" size="tiny" custom-class="account-dialog"
        ...
        <el-form :model="itemForm" ref="itemForm" label-width="70px" class="account-form"
          ...
          <el-form-item label="礼品价格，默认是0" prop="price">
    ...
    data () {
      return {
        ...
        itemFormRules: {
          ...
          price: [
            {required: true, message: '请输入礼品价格，默认是0'},
            {type: 'number', message: '值必须为数字'}
          ],
          comment: [
