  ...
  <div>
    <div class="content">
      ...
      <el-table :data="currentItems"
        ...
        <el-table-column prop="pic1"
                         label="图1"
                         sortable>
        </el-table-column>
        <el-table-column prop="pic2"
                         label="图2"
                         sortable>
        </el-table-column>
        <el-table-column prop="pic3"
                         label="图3"
                         sortable>
        </el-table-column>
        <el-table-column prop="pic4"
                         label="图4"
                         sortable>
        </el-table-column>
        <el-table-column prop="type"
                         label="评论类型，0：好评，1：中评，3：差评"
                         sortable>
        </el-table-column>
      ...
      <el-dialog title="编辑"
        ...
        <el-form :model="itemForm"
          ...
          <el-form-item label="购买者id"
                        prop="buyerId">
            <el-input v-model.number="itemForm.buyerId"></el-input>
          </el-form-item>
          <el-form-item label="处理订单者id"
                        prop="dealId">
          ...
          <el-form-item label="图4"
                        prop="pic4">
            <el-input v-model.trim="itemForm.pic4"></el-input>
          </el-form-item>
          <el-form-item label="评论类型，0：好评，1：中评，3：差评"
                        prop="type">
  ...
  data() {
    return {
      ...
      itemFormRules: {
        ...
        content: [{ required: true, message: '请输入评论类容' }],
        pic1: [{ required: true, message: '请输入图1' }],
        pic2: [{ required: true, message: '请输入图2' }],
        pic3: [{ required: true, message: '请输入图3' }],
        pic4: [{ required: true, message: '请输入图4' }],
        type: [
