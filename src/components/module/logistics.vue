  ...
  <div>
    <div class="content">
      ...
      <el-table :data="currentItems"
        ...
        <el-table-column prop="create_id"
                         label="物流订单创建人,可能是用户也可能是商家，看state类型"
                         sortable>
        </el-table-column>
        <el-table-column prop="logistics_compay_id"
                         label="物流公司id"
                         sortable>
        </el-table-column>
        <el-table-column prop="logistics_code"
                         label="物流单号"
                         sortable>
        </el-table-column>
      ...
      <el-dialog title="编辑"
        ...
        <el-form :model="itemForm"
                 ...
                 class="account-form"
                 :rules="itemFormRules">
          <el-form-item label="物流订单创建人,可能是用户也可能是商家，看state类型"
                        prop="createId">
            <el-input v-model.number="itemForm.createId"></el-input>
          </el-form-item>
          <el-form-item label="物流公司id"
                        prop="logisticsCompayId">
  ...
  data() {
    return {
      ...
      itemFormRules: {
        ...
        logisticsCode: [{ required: true, message: '请输入物流单号' }],
        price: [
        ...
        pic: [{ required: true, message: '请输入物流订单照片' }],
        state: [
